...
public class Simulator
{
    ...
    // The probability that a hunter will be created in any given grid position. This
    // new configuration is newly added to control creation of
    // hunters at the beginning of simulation.
    private static final double HUNTER_CREATION_PROBABILITY = 0.001;

    // Lists of actors in the field. Separate lists are kept for ease of iteration.
